    ...
    content: (
        <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
                 <Link href="/tool" className="text-blue-600 hover:underline font-medium">👉 Test it today</Link>
            </div>
        </div>
    )
  },
  ...
  },
  {
    ...
    content: (
        <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
            ...
            <div className="mt-8">
                 <Link href="/tool" className="text-blue-600 hover:underline font-bold text-lg">👉 Find out your password score today.</Link>
            </div>
        </div>
    )
  },
  {
    ...
    content: (
        <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
            ...
            <div className="mt-8">
                 <Link href="/tool" className="text-blue-600 hover:underline font-bold text-lg">👉 Test it safely and find out.</Link>
            </div>
        </div>
    )
  }
