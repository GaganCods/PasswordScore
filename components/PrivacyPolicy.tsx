      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in-up">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            We believe privacy is a fundamental right, not a feature. Here is exactly how PasswordScore handles your data.
          </p>
          ...
          <div className="space-y-12 relative z-10">
            ...
            <section className="space-y-4">
              ...
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                ...
                <p>
                  PasswordScore is a client-side application. When you type a password into the input field, the analysis logic runs locally on your device (computer, phone, or tablet). The data never leaves your browser environment.
                </p>
                <p>
            ...
            <section className="space-y-4">
              ...
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                <p>
                  PasswordScore does not use cookies for tracking or advertising purposes.
                </p>
                <p>
            ...
            <section className="space-y-4">
              ...
              <div className="text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
                  This website is hosted on a static hosting provider (e.g., GitHub Pages, Vercel, or Netlify). These providers may collect standard server logs (such as IP addresses) for security and performance monitoring. PasswordScore itself does not integrate with third-party analytics trackers, advertising networks, or social media pixels.
                </p>
              </div>
            </section>
            ...
            <section className="pt-8 border-t border-gray-200/50 dark:border-white/5">
              ...
              <a 
                  href="mailto:support@passwordscore.com" 
