      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="text-center lg:text-left space-y-10 animate-fade-in-up z-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white leading-[1.05]">
              <span className="block">Free Password</span>
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary-start to-primary-end pb-2 pr-2 lg:whitespace-nowrap">
                Strength Checker
              </span>
            </h1>
            
            <p className="text-xl sm:text-2xl lg:text-xl xl:text-2xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto lg:mx-0 lg:max-w-none leading-relaxed font-light">
              Instantly analyze resilience. Estimate crack times.<br />
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 pt-8">
               ...
               <div className="flex items-center gap-2 text-gray-600 dark:text-gray-300 font-medium">
                  <ShieldCheck size={20} className="text-violet-500" strokeWidth={2.5} />
